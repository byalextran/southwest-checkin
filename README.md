...
**Step 1:** In your user's home directory, create the file `.autoluv.env`.

    $ cd ~
    $ nano .autoluv.env

**Step 2:** Copy/paste the following in the text editor.
...
**Step 3:** Replace the values with the appropriate SMTP settings for your email provider and save the file (`Ctrl+O` to save, `Ctrl+X` to exit the editor).
...
Bug reports and pull requests are welcome on GitHub at https://github.com/byalextran/southwest-checkin. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [code of conduct](https://github.com/byalextran/southwest-checkin/blob/master/CODE_OF_CONDUCT.md).
...
Everyone interacting in the Southwest Checkin project's codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/autoluv/blob/master/CODE_OF_CONDUCT.md).
